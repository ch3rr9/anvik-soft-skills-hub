...
const analytics = {
  ...
  averageScore: 75,
  skillsProgress: [
    { name: "1С:Предприятие 8.3", progress: 85 },
    { name: "1С:ERP", progress: 60 },
            ...
            <div key={event.id} className="flex items-center justify-between p-3 border rounded-md">
              <div className="flex items-center space-x-3">
                <div className={`p-2 rounded-full ${
                  ...
                  event.type === "test" ? "bg-green-100" : "bg-purple-100"
                }`}>
                  {event.type === "meeting" ? (
              ...
              <Badge variant="outline" className={getEventColor(event.type)}>
                {event.type === "meeting" ? "Собрание" : 
                 event.type === "test" ? "Тест" : "Оценка"}
              </Badge>
            </div>
          ))}
        </div>
...
const ManagerTipsWidget = () => {
  ...
  return (
    <Card className="bg-anvik-primary text-white">
      <CardHeader className="pb-2">
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <Button variant="secondary" size="sm" onClick={() => toast({ title: "В разработке", description: "Функционал управления тестами в разработке" })}>
              Управление
            </Button>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <Button variant="secondary" size="sm" onClick={() => toast({ title: "В разработке", description: "Формирование отчетов в разработке" })}>
              Отчеты
            </Button>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <Button variant="secondary" size="sm" onClick={() => toast({ title: "В разработке", description: "Панель управления персоналом в разработке" })}>
              Настройки
            </Button>
          </div>
        </div>
